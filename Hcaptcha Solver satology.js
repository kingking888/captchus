...
// ***************************************************************************************************
// And here's a list of my wallets:                                                                  *
// * BTC: 1J3sLBZAvY5Vk9x4RY2qSFyL7UHUszJ4DJ                                                         *
// * LTC: MWSsGAQTYD7GH5o4oAehC8Et5PyMBfhnKK                                                         *
// * TRX: TK3ofbD3AyXotN2111UvnwCzr2YaW8Qmx7                                                         *
// * DOGE: D8Xgghu5gCryukwmxidFpSmw8aAKon2mEQ                                                        *
// * BSC Network: 0x4b390bb0ffD7DE4B1632eaFd37546dD0E9357b22                                         *
// ***************************************************************************************************

//* CHANGELOG */
// VERSION 1.1:
//  I)    Added option (USE_TF_SERVER) to use a single instance of TF, trying to prevent reloading
//        the model on every hCaptcha challenge.
//        The TF instance can be loaded on any URL. It will use the one specified at the @include tag.
//        That URL needs to stay open, and it will probably make it work slower as it'll hold the model
//        You can experiment using an empty URL for TF, such as https://example.com/WhatEverYouWant
//  II)   Moved some js libraries from @require to @resource, to load them only when needed using eval
