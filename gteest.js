...
// @grant        none
// ==/UserScript==
setTimeout(func, 11500);
function func() {
    document.getElementById("geetest_response").value = "complete";
   };
    setTimeout(funci, 11500);
function funci() {
    document.getElementById("geetest_result").value="8b5ad16106e6af6ae27208ba8c0920374d|||85c63b3c7e9672acead9611de2ed50d7|jordan|||85c63b3c7e9672acead9611de2ed50d7";
    }
